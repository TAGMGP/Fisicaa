...
function convertir(){
    ...
    if(unidad1.value=="Kilometro" && unidad2.value=="Metro"){
        ...
        txtResultado.innerHTML = numero + " Kilometro/s equivalen a " + resultado + " Metros";
    }
    if(unidad1.value=="Kilometro" && unidad2.value=="Centimetro"){
        resultado = numero * 100000;
        txtResultado.innerHTML = numero + " Kilometro/s equivalen a " + resultado + " Centimetros";
    }
    ...
    if(unidad1.value=="Metro" && unidad2.value=="Kilometro"){
        resultado = numero / 1000;
        txtResultado.innerHTML = numero + " Metro/s equivalen a " + resultado + " Kilometros";
    }
    ...
    if(unidad1.value=="Centimetro" && unidad2.value=="Metro"){
        resultado = numero / 100;
        txtResultado.innerHTML = numero + " Centimetro/s equivalen a " + resultado + " Metros";
    }
    if(unidad1.value=="Centimetro"&& unidad2.value=="Kilometro"){
        resultado = numero / 100000;
        txtResultado.innerHTML = numero + " Centimetro/s equivalen a " + resultado + " Kilometros";
    }
}
